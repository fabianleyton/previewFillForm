...
Author: Fabian Leyton 
Create Date: 2013-06-01
Modification Date: 2018-02-23
...
function setCoordinate(field, x1, y1, x2, y2, img) {
    ...
    configCoordinates.push(objCoordinates);
}

function init(){
    setCoordinate(19,58,132,73,0);
    setCoordinate(129,57,280,72,0);
    setCoordinate(283,59,356,74,0);
    setCoordinate(19,71,191,87,0);
    setCoordinate(190,72,274,85,0);
}


function campo(valX1, valY1, valX2, valY2, numPagina) {
    // --- numPagina defines the page in the coordinates was captured to show this
